                ...
                <ul class="nk-nav">
                    <li class="nk-nav-item has-sub"><a href="#" class="nk-nav-link nk-nav-toggle"><span
                        ...
                        <ul class="nk-nav-sub nk-nav-sub-lg">
                            ...
                            <li class="nk-nav-item"><a href="index-ecommerce.html"
                            ...
                            <li class="nk-nav-item"><a href="index-project.html"
                        ...
                        <ul class="nk-nav-sub">
                            <li class="nk-nav-item has-sub"><a href="#" class="nk-nav-link nk-nav-toggle">
                                ...
                                <ul class="nk-nav-sub">
                                    ...
                                    <li class="nk-nav-item has-sub"><a href="#"
                                            class="nk-nav-link nk-nav-toggle"> User Management </a>
                                        <ul class="nk-nav-sub">
                            ...
                            <li class="nk-nav-item"><a href="error/page-404.html" class="nk-nav-link"
                                    target="_blank"> Page 404 </a></li>
                        </ul>
                    </li>
                    <li class="nk-nav-item has-sub"><a href="#" class="nk-nav-link nk-nav-toggle"><span
                                class="nk-nav-text">Ui Elements</span></a>
                            ...
                            <div class="nk-nav-mega nk-nav-mega-lg">
                                <div class="nk-nav-col">
                                    ...
                                    <ul class="link-list link-list-md link-list-hover-bg-primary">
                                        ...
                                        <li><a href="components/badge.html">Badges</a></li>
                                        ...
                                        <li><a href="components/close-button.html">Close button</a></li>
                                        <li><a href="components/list-group.html">List group</a></li>
                                        <li><a href="components/pagination.html">Pagination</a></li>
                                        <li><a href="components/placeholders.html">Placeholders</a></li>
                                ...
                                <div class="nk-nav-col">
                                    ...
                                    <ul class="link-list link-list-md link-list-hover-bg-primary">
                                        ...
                                        <li><a href="components/navs-tabs.html">Tabs</a></li>
                                        <li><a href="components/offcanvas.html">Offcanvas</a></li>
                                    ...
                                    <ul class="link-list link-list-md link-list-hover-bg-primary">
                                        <li><a href="layout/breakpoints.html">Breakpoints</a></li>
                                ...
                                <div class="nk-nav-col">
                                    ...
                                    <ul class="link-list link-list-md link-list-hover-bg-primary">
                                        <li><a href="utilities/background.html">Background</a></li>
                                        ...
                                        <li><a href="utilities/images.html">Images</a></li>
                                        <li><a href="utilities/sizing.html">Sizing</a></li>
                                        <li><a href="utilities/spacing.html">Spacing</a></li>
                                        <li><a href="utilities/typography.html">Typography</a></li>
                                        <li><a href="utilities/tables.html">Tables</a></li>
                        ...
                        <div class="dropdown-menu dropdown-menu-md">
                            <div class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
                                <div class="media-group">
                                    ...
                                    <div class="media-text">
                                        <div class="lead-text">Admin</div><span class="sub-text">Owner &
                                            Founder</span>
                                    </div>
                                </div>
                            </div>
                            <div class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
                                <ul class="link-list">
                                    <li><a><em class="icon ni ni-user"></em>
                            ...
                            <div class="dropdown-content dropdown-content-x-lg py-3">
                                <ul class="link-list">
                                    <li><a><em class="icon ni ni-signout"></em>
                                            <span>LogOut</span>
                                        </a></li>
                                </ul>
                            </div>
