            ...
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    <li class="nk-menu-item has-sub">
                        {{-- <a href="{{ route('index') }}" class="nk-menu-link nk-menu-toggle"><span --}}
                        <a class="nk-menu-link nk-menu-toggle"><span class="nk-menu-icon"><em
                    ...
                    <li class="nk-menu-item has-sub">
                        <a href="#" class="nk-menu-link nk-menu-toggle">
                            <span class="nk-menu-icon"><em class="icon ni ni-bag"></em></span><span
                                class="nk-menu-text">eCommerce</span></a>

                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item"><a href="{{ route('furniture.index') }}" class="nk-menu-link"><span
                                        class="nk-menu-text">Furniture</span></a></li>
                            ...
                            <li class="nk-menu-item"><a href="{{ route('order.index') }}" class="nk-menu-link"><span
                                        class="nk-menu-text">Order</span></a>
                            </li> --}}
                        </ul>
                    </li>
                </ul>
